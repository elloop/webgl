...
function main() {
    ...
    modelMat.setRotate(-30, 0, 0, 1);

    var modelViewMat = viewMat.multiply(modelMat);
    var u_modelViewMat = gl.getUniformLocation(gl.program, "u_modelViewMat");
    gl.uniformMatrix4fv(u_modelViewMat, false, modelViewMat.elements);

    // or, another way to get modelViewMat:
    // var modelViewMat2 = new Matrix4();
    // modelViewMat2.setLookAt(0.2, 0.25, 0.25, 0, 0, 0, 0, 1, 0).rotate(45, 0, 0, 1);
    // gl.uniformMatrix4fv(u_modelViewMat, false, modelViewMat.elements);
